    ...
    <div  className="Regulamin">
      ...
      <ol>
        <li>
          ...
          url:&nbsp;<strong>www.wildrosses.</strong>shop
        </li>
        <li>
          Operatorem serwisu oraz Administratorem danych osobowych jest: Natalia
          Kidzińska z siedzibą w Dzierżoniowie, ul. Os.Jasne 10A/11, 58-200,
          Dzierżonów, NIP:8822134794, REGON: 385823861
        </li>
        <li>
          Adres kontaktowy poczty elektronicznej operatora:
          kontakt@wildrosses.shop
        </li>
        <li>
      ...
      <ol>
        ...
        <li>
          ...
          Franklina Roosevelta 22, 60-829 Poznań, wpisana do Krajowego Rejestru
          Sądowego przez Sąd Rejonowy Poznań – Nowe Miasto i Wilda w Poznaniu,
          Wydział VIII Gospodarczy Krajowego Rejestru Sądowego pod nr KRS
          0000612359, REGON 364261632, NIP 7822622168, kapitał zakładowy
          210.000,00 zł w pełni wpłacony.
        </li>
        <li>
          Pod adresem&nbsp;
          <a href="https://linuxpl.com/">https://linuxpl.com</a>&nbsp;możesz
          dowiedzieć się więcej o hostingu i sprawdzić politykę prywatności
          firmy hostingowej.
        </li>
        <li>
          Firma hostingowa:
          <ul>
            <li>
              stosuje środki ochrony przed utratą danych (np. macierze dyskowe,
              regularne kopie bezpieczeństwa),
            </li>
            <li>
              stosuje adekwatne środki ochrony miejsc przetwarzania na wypadek
              pożaru (np. specjalne systemy gaśnicze),
            </li>
            <li>
              stosuje adekwatne środki ochrony systemów przetwarzania na wypadek
              nagłej awarii zasilania (np. podwójne tory zasilania, agregaty,
              systemy podtrzymania napięcia UPS),
            </li>
            <li>
              stosuje środki fizycznej ochrony dostępu do miejsc przetwarzania
              danych (np. kontrola dostępu, monitoring),
            </li>
            <li>
              stosuje środki zapewnienia odpowiednich warunków środowiskowych
              dla serwerów jako elementów systemu przetwarzania danych (np.
              kontrola warunków środowiskowych, specjalistyczne systemy
              klimatyzacji),
            </li>
            <li>
