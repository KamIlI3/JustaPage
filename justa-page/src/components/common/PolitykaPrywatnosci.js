      ...
      <div className="FooterPages-content">
        ...
        <ol>
          ...
          <li>
            ...
            Natalia Kidzińska z siedzibą w Dzierżoniowie, ul. Os.Jasne 10A/11,
            58-200, Dzierżonów, NIP:8822134794, REGON: 385823861
          </li>
          <li>
        ...
        <ol>
          <li>
            ...
            operatora: linuxpl.com
          </li>
          <li>
            Dane rejestrowe firmy hostingowej: H88 S.A. z siedzibą w Poznaniu,
            Franklina Roosevelta 22, 60-829 Poznań, wpisana do Krajowego
            Rejestru Sądowego przez Sąd Rejonowy Poznań – Nowe Miasto i Wilda w
            Poznaniu, Wydział VIII Gospodarczy Krajowego Rejestru Sądowego pod
            nr KRS 0000612359, REGON 364261632, NIP 7822622168, kapitał
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                wypadek nagłej awarii zasilania (np. podwójne tory zasilania,
                agregaty, systemy podtrzymania napięcia UPS),
              </li>
              <li>
